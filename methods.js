...
function getUserById(array, id) {
  const res = array.find(function (element) {
...
function removeAddresses(array) {
  const wthAddres = array.map(function (element) {
...
function getUsersGeo(array, id) {
  const res = array.find(element => element.id === id);
  return res.address.geo;
}

console.log(getUsersGeo(users, 2));
...
function getUsersCompany(array, id) {
 const info = array.find (element => element.id === id)
 return info.company
}

console.log (getUsersCompany(users, 3))
...
function changePhone(array, id, phone ) {
    b = array.map(function (element, index, array) {
      if (id === element.id) {
     element.phone = phone
     return element
   } else {
...
console.log(changePhone(users, 2, '89284936238' ))
